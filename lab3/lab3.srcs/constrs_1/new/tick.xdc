...
set_property PACKAGE_PIN W7 [get_ports {led_segs_L[7]}]
set_property PACKAGE_PIN W6 [get_ports {led_segs_L[6]}]
set_property PACKAGE_PIN U8 [get_ports {led_segs_L[5]}]
set_property PACKAGE_PIN V8 [get_ports {led_segs_L[4]}]
set_property PACKAGE_PIN U5 [get_ports {led_segs_L[3]}]
set_property PACKAGE_PIN V5 [get_ports {led_segs_L[2]}]
set_property PACKAGE_PIN U7 [get_ports {led_segs_L[1]}]
set_property PACKAGE_PIN V7 [get_ports {led_segs_L[0]}]
